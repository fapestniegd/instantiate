...
url --url https://packages.lab.[% domainname %]/mirrors/fedora/latest/15/Fedora/i386/os --noverifyssl

# This line complains about a corrupted repomd.xml even from a fresh rsync:
repo --name=Everything --baseurl=https://packages.lab.[% domainname %]/mirrors/fedora/latest/15/Everything/i386/os --noverifyssl
