...
network --bootproto=static --addvmportgroup=false --device=vmnic0 --ip=[% ip %] --netmask=[% netmask %] --gateway=[% gateway %]  --nameserver=[% nameservers %] --hostname=[% fqdn %] --vlanid=12
...
esxcfg-vswitch -p VMkernel -v [% vmkvlan %] vSwitch0
esxcfg-vmknic -a -i [% vmkip %] -n [% vmknm %] -p VMkernel
...
esxcfg-vswitch -p VLAN_8 -v 8 vSwitch1
